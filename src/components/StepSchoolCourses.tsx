...
const StepSchoolCourses: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-xs mx-auto bg-white rounded-2xl p-6 flex flex-col items-center shadow-lg text-center">
      ...
      <p className="text-sm text-gray-600 mb-4">Clique para ver os cursos referente a essa Escola:</p>
      ...
      <button
        className="mt-2 px-4 py-2 text-white rounded-full font-semibold"
        style={{ backgroundColor: color }}
        onClick={() => setStep(0)}
      >
        Voltar
